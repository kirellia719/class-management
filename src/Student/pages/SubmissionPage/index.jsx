...
const ExamSubmission = ({ submission }) => {
   ...
   return (
      <div className="SubmissionPage">
         ...
         >
            <DialogTitle id="dialog-submit-exam-title">{"Xác nhận nộp bài"}</DialogTitle>
            <DialogContent>
               <DialogContentText id="dialog-submit-exam-description">
                  Bạn có chắc chắn muốn nộp bài thi? Sau khi nộp, bạn sẽ không thể sửa lại đáp án. Hãy nhớ rằng gian để
                  trả lời câu hỏi là {formatTime(timeLeft)}.
               </DialogContentText>
            </DialogContent>
            <DialogActions>
               <Button onClick={() => setConfirmSubmit(false)} color="info">
                  Quay lại
               </Button>
                  ...
                  <Stack spacing={3}>
                     ...
                     <Box className="exam-submit-container">
                        ...
                        <div className="exam-title" style={{ marginTop: 10 }}>
                           ...
                           <div className="title" style={{ color: "#312fae" }}>
                              {formatTime(timeLeft)}
                           </div>
                        </div>
                     </Box>
                     ...
                     <Paper sx={{ p: 2 }} className="exam-title">
                        <Button
                           variant="outlined"
                           color="error"
                           onClick={() => navigate(`/exam/${submission.exam._id}`)}
                        >
                           Thoát
                        </Button>
            ...
            <Stack sx={{ p: 2, m: 2 }} spacing={2}>
               <div>
                  ...
                  {submission.score == null
                     ? "Bạn chưa nộp bài"
                     : `Bạn trả lời đúng ${submission.score}/${submission.exam.questions.length} câu`}
               </div>
               <div>
                  <Button
                     onClick={() => {
                        navigate(`/exam/${submission.exam._id}`);
                     }}
                  >
                     Quay lại
                  </Button>
